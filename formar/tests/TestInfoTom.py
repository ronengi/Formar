...
class TestEncodeDecode(unittest.TestCase):
    ...
    def test_encode_decode(self):
        it = InfoTom(it_id=123, contents='Horses', lang_rtl=True,
    ...
    def test_encode(self):
        it = InfoTom(it_id=123, contents='Horses', lang_rtl=True,
                     left=12, top=34, width=56, height=78,
                     parent_bond=None)
        j_str = '{"__InfoTom__": {"it_id": 123, "contents": "Horses", "lang_rtl": true, "left": 12, "top": 34, "width": 56, "height": 78, "parent_bond": null}}'
